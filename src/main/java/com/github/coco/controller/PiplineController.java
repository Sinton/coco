 ...
 */
@RestController
@RequestMapping(value = "/api/pipline")
public class PiplineController extends BaseController {

    @WebLog
    @PostMapping("/list")
    public Map<String, Object> getPagePipline(@RequestBody Map<String, Object> params) {
